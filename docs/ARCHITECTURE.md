...
Production fixes the executable, an empty trusted Bun configuration, and the
argument to the checked-in observer; environment-selected commands and
project-local preloads are rejected and cannot forge readiness.

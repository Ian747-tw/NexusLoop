...
active execution.
The production observer command, empty Bun configuration, and argument are
code-owned. Runtime rejects the former environment override keys and project
preloads; custom observer processes remain only a package-internal unit-test
seam.

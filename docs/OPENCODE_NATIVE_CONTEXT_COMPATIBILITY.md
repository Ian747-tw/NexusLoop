...
- `RuntimeServerClient` has no-start handling for preview, list, get, summary, dry-run session planning, handoff readiness, smoke previews, result review packets, and result-review metadata.

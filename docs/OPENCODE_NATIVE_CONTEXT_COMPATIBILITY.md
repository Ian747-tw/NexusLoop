...
- Current 9Q search is bounded lexical retrieval only. It reports matched terms, matched fields, scoring explanation, scan limits, and disabled semantic/vector/FTS status so Commander can evaluate retrieval limits honestly.
...
- 9R: Commander research proposal gate
- Future: semantic/FTS research-memory indexing and end-to-end supervised training demo

...
function isNoStartInspectionText(text: string): boolean {
  ...
  return (
	    ...
	    || trimmed.startsWith("/result-review-preview")
	    || trimmed.startsWith("/result-review-dry-run")
	    || trimmed.startsWith("/result-reviews")
	    || trimmed.startsWith("/result-review-latest")
	    || trimmed.startsWith("/result-review-show")
	    || trimmed.startsWith("/result-review-summary")
	    || trimmed === "/result-review"
	    || trimmed.startsWith("/result-review ")
    ...
    || trimmed.startsWith("/opencode-watchdog-preview")
    || trimmed.startsWith("/session-watchdog")
    || trimmed.startsWith("/watchdog-preview")
    || trimmed.startsWith("/opencode-watchdog-dry-run")
    || trimmed.startsWith("/opencode-watchdog-record")
    || trimmed.startsWith("/watchdog-record")
    || trimmed.startsWith("/opencode-force-report-dry-run")
    || trimmed.startsWith("/opencode-force-report")
    || trimmed.startsWith("/force-report")
    || trimmed.startsWith("/session-force-report")
    || trimmed.startsWith("/opencode-watchdogs")
    || trimmed.startsWith("/opencode-watchdog-show")
    || trimmed.startsWith("/opencode-force-report-requests")
    || trimmed.startsWith("/forced-reports")
    || trimmed.startsWith("/opencode-force-report-show")
    || trimmed.startsWith("/opencode-watchdog-summary")
    || trimmed.startsWith("/watchdog-summary")
    || trimmed.startsWith("/opencode-wake-supervisor-preview")
    || trimmed.startsWith("/wake-supervisor-preview")
    || trimmed.startsWith("/session-supervisor")
    || trimmed.startsWith("/opencode-supervisor")
    || trimmed.startsWith("/opencode-wake-supervisor-summary")
    || trimmed.startsWith("/wake-supervisor-summary")
    || trimmed.startsWith("/supervisor-summary")
    || trimmed.startsWith("/opencode-wake-execution-preview")
    || trimmed.startsWith("/wake-execution-preview")
    || trimmed.startsWith("/opencode-wake-execution-dry-run")
    || trimmed.startsWith("/wake-execution-dry-run")
    || trimmed.startsWith("/opencode-wake-execution-record")
    || trimmed.startsWith("/wake-execution-record")
    || trimmed.startsWith("/opencode-wake-batch-preview")
    || trimmed.startsWith("/wake-batch-preview")
    || trimmed.startsWith("/opencode-wake-batch-dry-run")
    || trimmed.startsWith("/wake-batch-dry-run")
    || trimmed.startsWith("/opencode-wake-batch-record")
    || trimmed.startsWith("/wake-batch-record")
    || trimmed.startsWith("/opencode-wake-executions")
    || trimmed.startsWith("/wake-executions")
    || trimmed.startsWith("/opencode-wake-execution-latest")
    || trimmed.startsWith("/wake-execution-latest")
    || trimmed.startsWith("/opencode-wake-execution-show")
    || trimmed.startsWith("/opencode-wake-execution-summary")
    || trimmed.startsWith("/wake-execution-summary")
	    || trimmed.startsWith("/opencode-ask-commander-preview")
	    || trimmed.startsWith("/ask-commander-preview")
	    || trimmed.startsWith("/opencode-ask-commander-dry-run")
	    || trimmed.startsWith("/ask-commander-dry-run")
	    || trimmed.startsWith("/opencode-ask-commander")
	    || trimmed.startsWith("/ask-commander")
	    || trimmed.startsWith("/commander-question")
	    || trimmed.startsWith("/opencode-commander-questions")
	    || trimmed.startsWith("/commander-questions")
    || trimmed.startsWith("/opencode-commander-question-latest")
    || trimmed.startsWith("/question-latest")
    || trimmed.startsWith("/opencode-commander-question-show")
    || trimmed.startsWith("/opencode-commander-question-summary")
    || trimmed.startsWith("/commander-guidance")
    || trimmed.startsWith("/answer-commander-question")
    || trimmed.startsWith("/answer-question")
    || trimmed.startsWith("/guidance-preview")
    || trimmed.startsWith("/guidance-dry-run")
    || trimmed.startsWith("/guidance-list")
    || trimmed.startsWith("/guidance-latest")
    || trimmed.startsWith("/guidance-delivery-preview")
    || trimmed.startsWith("/guidance-delivery-dry-run")
    || trimmed.startsWith("/deliver-guidance")
    ...
    || trimmed.startsWith("/research-memory-show")
    || trimmed.startsWith("/research-memory-inspect")
    || trimmed.startsWith("/research-memory-near-duplicates")
    || trimmed.startsWith("/research-memory-profile")
    || trimmed.startsWith("/research-search-profile")
    || trimmed.startsWith("/research-search")
    || trimmed.startsWith("/memory-search")
    || trimmed.startsWith("/memory-show")
    || trimmed.startsWith("/memory-inspect")
    || trimmed.startsWith("/memory-duplicates")
    || trimmed.startsWith("/memory-profile")
    || trimmed.startsWith("/research-inspect")
    || trimmed.startsWith("/research-duplicates")
    || trimmed.startsWith("/research-near-duplicates")

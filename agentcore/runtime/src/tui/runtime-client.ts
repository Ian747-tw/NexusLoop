...
import type { OpenCodeHumanControlPreview, OpenCodeHumanControlPreviewInput, OpenCodeHumanControlRecord, OpenCodeHumanControlRecordInput, OpenCodeHumanControlResult, OpenCodeHumanControlSummary } from "../opencode-session/opencode-human-control-types"
import type { OpenCodeWakeSupervisorPreview, OpenCodeWakeSupervisorPreviewInput, OpenCodeWakeSupervisorSummary, OpenCodeWakeSupervisorSummaryInput } from "../opencode-session/opencode-wake-supervisor-types"
...
export interface RuntimeClient {
  ...
  command(name: "runtime.preview_opencode_human_control", payload?: OpenCodeHumanControlPreviewInput | { sessionId?: string; session_id?: string; session?: string; launchId?: string; launch_id?: string; launch?: string; controlKind?: string; control_kind?: string; kind?: string; urgency?: string; humanNote?: string; human_note?: string; note?: string; correction?: string; override?: string; reason?: string; progressId?: string; progress_id?: string; progress?: string; watchdogId?: string; watchdog_id?: string; watchdog?: string; forcedReportRequestId?: string; forced_report_request_id?: string; forcedReport?: string; forced_report?: string; questionId?: string; question_id?: string; question?: string; guidanceId?: string; guidance_id?: string; guidance?: string; deliveryId?: string; delivery_id?: string; delivery?: string }): Promise<OpenCodeHumanControlPreview>
  command(name: "runtime.record_opencode_human_control", payload?: OpenCodeHumanControlRecordInput | { sessionId?: string; session_id?: string; session?: string; launchId?: string; launch_id?: string; launch?: string; controlKind?: string; control_kind?: string; kind?: string; urgency?: string; humanNote?: string; human_note?: string; note?: string; correction?: string; override?: string; reason?: string; progressId?: string; progress_id?: string; progress?: string; watchdogId?: string; watchdog_id?: string; watchdog?: string; forcedReportRequestId?: string; forced_report_request_id?: string; forcedReport?: string; forced_report?: string; questionId?: string; question_id?: string; question?: string; guidanceId?: string; guidance_id?: string; guidance?: string; deliveryId?: string; delivery_id?: string; delivery?: string; dryRun?: boolean; dry_run?: boolean; recordedBy?: string; recorded_by?: string }): Promise<OpenCodeHumanControlResult>
  command(name: "runtime.list_opencode_human_controls", payload?: { limit?: number; session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string; control_kind?: string; controlKind?: string; kind?: string; projected_state_after?: string; projectedStateAfter?: string; state?: string; urgency?: string }): Promise<OpenCodeHumanControlRecord[]>
  command(name: "runtime.get_opencode_human_control", payload: { control_id: string } | { controlId: string }): Promise<OpenCodeHumanControlResult | null>
  command(name: "runtime.latest_opencode_human_control", payload?: { session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string }): Promise<OpenCodeHumanControlResult | null>
  command(name: "runtime.opencode_human_control_summary", payload?: { limit?: number }): Promise<OpenCodeHumanControlSummary>
  command(name: "runtime.preview_opencode_wake_supervisor", payload?: OpenCodeWakeSupervisorPreviewInput | { sessionId?: string; session_id?: string; session?: string; launchId?: string; launch_id?: string; launch?: string; includeResearchMemory?: boolean; include_research_memory?: boolean; includeContextPacket?: boolean; include_context_packet?: boolean; includeHumanControls?: boolean; include_human_controls?: boolean; includeGuidanceDelivery?: boolean; include_guidance_delivery?: boolean; limitEvidence?: number; limit_evidence?: number }): Promise<OpenCodeWakeSupervisorPreview>
  command(name: "runtime.opencode_wake_supervisor_summary", payload?: OpenCodeWakeSupervisorSummaryInput | { limit?: number; includeResearchMemory?: boolean; include_research_memory?: boolean; includeHumanControls?: boolean; include_human_controls?: boolean; statusFilter?: string; status_filter?: string; status?: string }): Promise<OpenCodeWakeSupervisorSummary>
  command(name: "runtime.preview_opencode_wake_supervisor_execution", payload?: OpenCodeWakeSupervisorExecutionPreviewInput | { sessionId?: string; session_id?: string; session?: string; launchId?: string; launch_id?: string; launch?: string; includeResearchMemory?: boolean; include_research_memory?: boolean; includeContextPacket?: boolean; include_context_packet?: boolean; includeHumanControls?: boolean; include_human_controls?: boolean; includeGuidanceDelivery?: boolean; include_guidance_delivery?: boolean; limitEvidence?: number; limit_evidence?: number }): Promise<OpenCodeWakeSupervisorExecutionPreview>
  command(name: "runtime.record_opencode_wake_supervisor_execution", payload?: OpenCodeWakeSupervisorExecutionRecordInput | { sessionId?: string; session_id?: string; session?: string; launchId?: string; launch_id?: string; launch?: string; includeResearchMemory?: boolean; include_research_memory?: boolean; includeContextPacket?: boolean; include_context_packet?: boolean; includeHumanControls?: boolean; include_human_controls?: boolean; includeGuidanceDelivery?: boolean; include_guidance_delivery?: boolean; limitEvidence?: number; limit_evidence?: number; dryRun?: boolean; dry_run?: boolean; recordedBy?: string; recorded_by?: string }): Promise<OpenCodeWakeSupervisorExecutionResult>
  command(name: "runtime.preview_opencode_wake_supervisor_batch", payload?: OpenCodeWakeSupervisorBatchPreviewInput | { limit?: number; statusFilter?: string; status_filter?: string; status?: string; includeResearchMemory?: boolean; include_research_memory?: boolean; includeHumanControls?: boolean; include_human_controls?: boolean; includeGuidanceDelivery?: boolean; include_guidance_delivery?: boolean; limitEvidence?: number; limit_evidence?: number }): Promise<OpenCodeWakeSupervisorBatchPreview>
  command(name: "runtime.record_opencode_wake_supervisor_batch", payload?: OpenCodeWakeSupervisorBatchRecordInput | { limit?: number; statusFilter?: string; status_filter?: string; status?: string; includeResearchMemory?: boolean; include_research_memory?: boolean; includeHumanControls?: boolean; include_human_controls?: boolean; includeGuidanceDelivery?: boolean; include_guidance_delivery?: boolean; limitEvidence?: number; limit_evidence?: number; dryRun?: boolean; dry_run?: boolean; recordedBy?: string; recorded_by?: string }): Promise<OpenCodeWakeSupervisorBatchResult>
  command(name: "runtime.list_opencode_wake_supervisor_executions", payload?: { limit?: number; session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string; supervisor_status?: string; supervisorStatus?: string; status?: string; recommended_action?: string; recommendedAction?: string; action?: string; execution_mode?: string; executionMode?: string; mode?: string }): Promise<OpenCodeWakeSupervisorExecutionRecord[]>
  command(name: "runtime.get_opencode_wake_supervisor_execution", payload: { execution_id: string } | { executionId: string }): Promise<OpenCodeWakeSupervisorExecutionResult | null>
  command(name: "runtime.latest_opencode_wake_supervisor_execution", payload?: { session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string }): Promise<OpenCodeWakeSupervisorExecutionResult | null>
  command(name: "runtime.opencode_wake_supervisor_execution_summary", payload?: { limit?: number }): Promise<OpenCodeWakeSupervisorExecutionSummary>
  command(name: "runtime.preview_opencode_wake_action_execution", payload?: OpenCodeWakeActionExecutionPreviewInput | { executionId?: string; execution_id?: string; execution?: string; actionKind?: string; action_kind?: string; action?: string; allowOperatorHandoff?: boolean; allow_operator_handoff?: boolean; answer?: string; reason?: string }): Promise<OpenCodeWakeActionExecutionPreview>
  command(name: "runtime.record_opencode_wake_action_execution", payload?: OpenCodeWakeActionExecutionRecordInput | { executionId?: string; execution_id?: string; execution?: string; actionKind?: string; action_kind?: string; action?: string; allowOperatorHandoff?: boolean; allow_operator_handoff?: boolean; answer?: string; reason?: string; dryRun?: boolean; dry_run?: boolean; recordedBy?: string; recorded_by?: string }): Promise<OpenCodeWakeActionExecutionResult>
  command(name: "runtime.list_opencode_wake_action_executions", payload?: { limit?: number; execution_id?: string; executionId?: string; execution?: string; session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string; action_kind?: string; actionKind?: string; action?: string; status?: string; effect_kind?: string; effectKind?: string; effect?: string }): Promise<OpenCodeWakeActionExecutionRecord[]>
  command(name: "runtime.get_opencode_wake_action_execution", payload: { action_execution_id: string } | { actionExecutionId: string }): Promise<OpenCodeWakeActionExecutionResult | null>
  command(name: "runtime.latest_opencode_wake_action_execution", payload?: { execution_id?: string; executionId?: string; execution?: string; session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string }): Promise<OpenCodeWakeActionExecutionResult | null>
  command(name: "runtime.opencode_wake_action_execution_summary", payload?: { limit?: number }): Promise<OpenCodeWakeActionExecutionSummary>
  command(name: "runtime.preview_opencode_result_report", payload?: OpenCodeResultReportPreviewInput | { sessionId?: string; session_id?: string; session?: string; launchId?: string; launch_id?: string; launch?: string; resultKind?: string; result_kind?: string; kind?: string; summary?: string; outcome?: string; changedFiles?: string[]; changed_files?: string[]; testsRun?: string[]; tests_run?: string[]; testResults?: string[]; test_results?: string[]; artifacts?: string[]; metrics?: string[]; claims?: string[]; knownFailures?: string[]; known_failures?: string[]; followups?: string[]; confidence?: number | string; progressId?: string; progress_id?: string; progress?: string; watchdogId?: string; watchdog_id?: string; watchdog?: string; questionId?: string; question_id?: string; question?: string; guidanceId?: string; guidance_id?: string; guidance?: string; deliveryId?: string; delivery_id?: string; delivery?: string; wakeExecutionId?: string; wake_execution_id?: string; wakeExecution?: string; wake_execution?: string; wakeActionExecutionId?: string; wake_action_execution_id?: string; wakeAction?: string; wake_action?: string; reviewState?: string; review_state?: string }): Promise<OpenCodeResultReportPreview>
  command(name: "runtime.record_opencode_result_report", payload?: OpenCodeResultReportRecordInput | { sessionId?: string; session_id?: string; session?: string; launchId?: string; launch_id?: string; launch?: string; resultKind?: string; result_kind?: string; kind?: string; summary?: string; outcome?: string; changedFiles?: string[]; changed_files?: string[]; testsRun?: string[]; tests_run?: string[]; testResults?: string[]; test_results?: string[]; artifacts?: string[]; metrics?: string[]; claims?: string[]; knownFailures?: string[]; known_failures?: string[]; followups?: string[]; confidence?: number | string; progressId?: string; progress_id?: string; progress?: string; watchdogId?: string; watchdog_id?: string; watchdog?: string; questionId?: string; question_id?: string; question?: string; guidanceId?: string; guidance_id?: string; guidance?: string; deliveryId?: string; delivery_id?: string; delivery?: string; wakeExecutionId?: string; wake_execution_id?: string; wakeExecution?: string; wake_execution?: string; wakeActionExecutionId?: string; wake_action_execution_id?: string; wakeAction?: string; wake_action?: string; reviewState?: string; review_state?: string; dryRun?: boolean; dry_run?: boolean; recordedBy?: string; recorded_by?: string }): Promise<OpenCodeResultReportResult>
  command(name: "runtime.list_opencode_result_reports", payload?: { limit?: number; session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string; result_kind?: string; resultKind?: string; kind?: string; result_disposition?: string; resultDisposition?: string; disposition?: string; review_state?: string; reviewState?: string }): Promise<OpenCodeResultReportRecord[]>
  ...
  command(name: "runtime.preview_research_ingestion", payload?: ResearchIngestionPreviewInput | { reviewId?: string; review_id?: string; review?: string; evidenceKind?: string; evidence_kind?: string; tags?: string[]; researchTitle?: string; research_title?: string; researchQuestion?: string; research_question?: string; hypothesis?: string; method?: string; noveltyKey?: string; novelty_key?: string; recordedBy?: string; recorded_by?: string }): Promise<ResearchIngestionPreview>
  command(name: "runtime.record_research_ingestion", payload?: ResearchIngestionRecordInput | { reviewId?: string; review_id?: string; review?: string; evidenceKind?: string; evidence_kind?: string; tags?: string[]; researchTitle?: string; research_title?: string; researchQuestion?: string; research_question?: string; hypothesis?: string; method?: string; noveltyKey?: string; novelty_key?: string; dryRun?: boolean; dry_run?: boolean; recordedBy?: string; recorded_by?: string }): Promise<ResearchIngestionResult>
  command(name: "runtime.list_research_ingestions", payload?: { limit?: number; review_id?: string; reviewId?: string; review?: string; report_id?: string; reportId?: string; report?: string; session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string; evidence_kind?: string; evidenceKind?: string; research_db_written?: boolean; researchDbWritten?: boolean }): Promise<ResearchIngestionRecord[]>
  command(name: "runtime.get_research_ingestion", payload: { ingestion_id: string } | { ingestionId: string }): Promise<ResearchIngestionResult | null>
  command(name: "runtime.latest_research_ingestion", payload?: { review_id?: string; reviewId?: string; review?: string; report_id?: string; reportId?: string; report?: string; session_id?: string; sessionId?: string; session?: string; launch_id?: string; launchId?: string; launch?: string }): Promise<ResearchIngestionResult | null>
  command(name: "runtime.research_ingestion_summary", payload?: { limit?: number }): Promise<ResearchIngestionSummary>
  command(name: "runtime.research_memory_summary", payload?: Record<string, never>): Promise<ResearchMemorySummary>
  command(name: "runtime.preview_research_memory_retrieval", payload?: ResearchMemoryRetrievalInput | { query?: string; labels?: string[]; limit?: number; sourceKind?: string; source_kind?: string; missionId?: string; mission_id?: string; sessionId?: string; session_id?: string; includeFailures?: boolean; include_failures?: boolean; includeArtifacts?: boolean; include_artifacts?: boolean; resultType?: string; result_type?: string; resultStatus?: string; result_status?: string; confidence?: string; evidenceKind?: string; evidence_kind?: string; hasArtifacts?: boolean; has_artifacts?: boolean; hasCitations?: boolean; has_citations?: boolean; hasMetrics?: boolean; has_metrics?: boolean; since?: string; until?: string; sort?: string; explain?: boolean }): Promise<ResearchMemoryRetrievalPreview>
  command(name: "runtime.get_research_memory_record", payload?: ResearchMemoryInspectionInput | { memoryId?: string; memory_id?: string; id?: string; sourceKind?: string; source_kind?: string; source?: string; includeArtifacts?: boolean; include_artifacts?: boolean; includeCitations?: boolean; include_citations?: boolean }): Promise<ResearchMemoryInspectionPreview>
  command(name: "runtime.preview_research_memory_near_duplicates", payload?: ResearchMemoryNearDuplicateInput | { query?: string; objective?: string; labels?: string[]; limit?: number; duplicateThreshold?: number; duplicate_threshold?: number; missionId?: string; mission_id?: string; sessionId?: string; session_id?: string; includeFailures?: boolean; include_failures?: boolean; includeArtifacts?: boolean; include_artifacts?: boolean }): Promise<ResearchMemoryNearDuplicatePreview>
  command(name: "runtime.research_memory_search_profile", payload?: Record<string, never>): Promise<ResearchMemorySearchProfile>
  command(name: "runtime.preview_commander_proposal_continuity", payload?: CommanderProposalContinuityInput | { objective?: string; missionId?: string; mission_id?: string; mission?: string; sessionId?: string; session_id?: string; session?: string; includeResearchMemory?: boolean; include_research_memory?: boolean; includeNearDuplicates?: boolean; include_near_duplicates?: boolean; includeOpenLoops?: boolean; include_open_loops?: boolean; includeRecentSessions?: boolean; include_recent_sessions?: boolean; maxRecentSessions?: number; max_recent_sessions?: number; maxOpenLoops?: number; max_open_loops?: number; maxResearchCandidates?: number; max_research_candidates?: number; maxInspectedMemory?: number; max_inspected_memory?: number; targetTokenBudget?: number; target_token_budget?: number; modelId?: string; model_id?: string }): Promise<CommanderProposalContinuityPacket>
  command(name: "runtime.preview_commander_midmission_continuity", payload?: CommanderMidMissionContinuityInput | { sessionId?: string; session_id?: string; session?: string; launchId?: string; launch_id?: string; launch?: string; includeResearchMemory?: boolean; include_research_memory?: boolean; includeOpenLoops?: boolean; include_open_loops?: boolean; includeLocalWorkingMemory?: boolean; include_local_working_memory?: boolean; maxOpenLoops?: number; max_open_loops?: number; maxResearchCandidates?: number; max_research_candidates?: number; targetTokenBudget?: number; target_token_budget?: number; modelId?: string; model_id?: string }): Promise<CommanderMidMissionContinuityPacket>

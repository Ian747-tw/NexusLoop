...
export const COMMAND_AUTHORITY_REGISTRY: CommandAuthorityRecord[] = [
  ...
  write({ slash: "/wake-tick-dry-run", runtime: "runtime.execute_wake_schedule_tick", risk: "low_risk_write", gate: "wake_schedule_tick", owner: "wake_schedule", events: ["runtime_wake_schedule_tick_dry_run"], reads: ["/wake-tick-preview"], profile: profiles.wakeSchedule }),
  ...
  write({ slash: "/handoff", runtime: "runtime.execute_opencode_handoff", risk: "high_impact_write", gate: "handoff_runtime", owner: "opencode_handoff", events: ["runtime_opencode_handoff_started", "runtime_opencode_handoff_succeeded"], reads: ["/handoff-preview", "/handoff-followups"], process: true, profile: profiles.handoff }),
  write({ slash: "/synthesize", runtime: "runtime.execute_research_synthesis", risk: "high_impact_write", gate: "reasoning_provider_runtime", owner: "reasoning_provider", events: ["runtime_research_synthesis_completed"], provider: true, reads: ["/synthesize-preview", "/syntheses"], profile: profiles.synthesis }),
  write({ slash: "/cycle", runtime: "runtime.execute_commander_cycle", risk: "high_impact_write", gate: "reasoning_provider_runtime", owner: "commander_cycle", events: ["runtime_commander_cycle_completed"], provider: true, reads: ["/cycle-preview", "/cycles"], profile: profiles.cycle }),
  write({ slash: "/api-call", runtime: "runtime.execute_external_api_request", risk: "high_impact_write", gate: "external_api_runtime", owner: "reasoning_provider", events: ["runtime_external_api_request_completed"], reads: ["/api-preview", "/api-audit"], profile: profiles.externalApi }),
  ...
  write({ slash: "/cancel-mission", runtime: "runtime.cancel_mission", risk: "high_impact_write", gate: "mission_runtime", owner: "mission", events: ["mission_cancelled"], reads: ["/mission"], profile: profiles.mission, aliases: ["/cancel"] }),

...
Use this backend only when the user explicitly chooses the custom skill-pack path during `nxl init`.
...
3. `.nxl/onboarding.yaml` or `.nxl/onboarding.json` if present.

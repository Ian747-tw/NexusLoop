"""
hardware.py — Detect and report hardware information for NexusLoop.

Config is saved to .nxl/hardware.yaml (fallback: hardware.json)
...
class HardwareDetector:
    ...
    def save(self, project_dir: Path, info: HardwareInfo) -> None:
        """Save HardwareInfo to .nxl/hardware.yaml (or .json)."""

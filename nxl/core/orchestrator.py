"""
Orchestrator — the single decision authority for NexusLoop.
"""
...
class Orchestrator:
    ...
    def initialize_project(self, spec: dict) -> None:
        ...
        Creates .nxl/ directory, writes initial state, and
    ...
    def _scaffold_config_files(self, config_dir: Path) -> None:
        ...
        defaults: Dict[str, str] = {
            ...
            "hardware.yaml": (
                "# NexusLoop — hardware constraints\n"

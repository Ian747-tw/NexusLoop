"""
NexusLoop CLI — argparse-based entry point.

Each subcommand delegates to the appropriate module in
``nxl.core`` or ``nxl.dashboard``.
"""
...
def _core_init():
    from nxl.core import init as _init
    return _init

def _core_doctor():
    from nxl.core import doctor as _doctor
    return _doctor

def _core_run():
    from nxl.core import run as _run
    return _run

def _core_status():
    from nxl.core import status as _status
    return _status

def _core_plan():
    from nxl.core import plan as _plan
    return _plan

def _core_research():
    from nxl.core import research as _research
    return _research

def _core_resume():
    from nxl.core import resume as _resume
    return _resume

def _core_check():
    from nxl.core import check as _check
    return _check

def _core_stop():
    from nxl.core import stop as _stop
    return _stop
...
def _cmd_install(args: argparse.Namespace) -> int:
    console("NexusLoop installed successfully.", "success")
    ...
    print("  4.  nxl run")
    print()
    console("Run `nxl --help` for full command list.", "info")
    return 0
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="nxl",
        description=(
            "NexusLoop — autonomous deep reinforcement learning "
    ...
    p_install = sub.add_parser(
        ...
        description=(
            "Confirm that NexusLoop is installed correctly and "
    ...
    p_init = sub.add_parser(
        "init",
        help="Scaffold a new NexusLoop project.",
        description=(
            "Initialise the target project directory by creating the "
            ".nxl/ config folder, logs/, skills/, and "
    ...
    p_init.add_argument(
        ...
        action="store_true",
        help=(
            "Remove NexusLoop-managed config, state, and plugin files in "
    ...
    p_plan = sub.add_parser(
        ...
        description=(
            ...
            ".nxl/. Pass --refresh to regenerate the plan "

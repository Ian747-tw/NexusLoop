...
3. Add a read-only OpenCode-owned observer that validates complete ordinary config/auth schemas, then evaluates only the exact requested provider/model and credential presence.
